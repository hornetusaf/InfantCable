...
<title>infantcable Planes de telefonia.</title>
      ...
      <div class="post">
					...
					if(isset($_POST["select"]))
					{
			  			...
			  			if($fila=mysql_fetch_array($res))
						{
							if($fila["telefonia"]==-1)
							{
								...
								if($fila["paquetes"]==-1)
								{
								  $sql="update usuario set telefonia='".$_POST["select"]."' where usuario='".$_SESSION["nombre_usuario"]."'";
								...
								if($res=$clase->query($sql))
								  ...
								  echo "Debe Eliminar el paquete que tiene incluido ya un plan de telefonia<br>";
								}
																
							}
							else
								echo "Usted ya posee plan de telefonia.";
						}
					}
					else
        ...
        <form id="form4" method="post" action="">
          <?php
	            ...
	            echo '</tr>';
		        echo '<tr>';
		          echo '<td><b>Minutos: </b>'.$fila["minutos"].'</td>';
	            echo '</tr>';
		        echo '<tr>';
