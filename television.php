...
<title>infantcable Planes de television.</title>
      ...
      <div class="post">
					...
					if(isset($_POST["select"]))
					{
			  			...
			  			if($fila=mysql_fetch_array($res))
						{
							...
							{													
								if($fila["paquetes"]==-1)
								{
								  $sql="update usuario set television='".$_POST["select"]."' where usuario='".$_SESSION["nombre_usuario"]."'";
								...
								if($band==0)
								{
								  ...
								  echo "Debe Eliminar el paquete que tiene incluido ya un plan de television<br>";
								}																
							}
							else
								echo "Usted ya posee plan de television.";
						}
					}
					else
        ...
        <form id="form4" method="post" action="">
          <?php
	            ...
	            echo '</tr>';
		        echo '<tr>';
		          echo '<td><b>Canales: </b>'.$fila["canales"].'</td>';
	            echo '</tr>';
		        echo '<tr>';
