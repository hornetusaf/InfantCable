...
<title>infantcable Registro de nuevo usuario.</title>
    ...
    <div id="content">
      <div class="post">
        <?php		  	
			...
			{
				if(!empty($_POST["usuario"]) && !empty($_POST["clave"]) && !empty($_POST["nombre"]) && !empty($_POST["apellido"]) && !empty($_POST["direccion"]) && !empty($_POST["telefono"]) && !empty($_POST["email"]))
				{					
					$clase=new mysql();
					if(!$clase->conectar())
					...
					{	
						...
						{	//no existe creamos la persona...
							$sql="insert into usuario values('".$_POST["usuario"]."','".$_POST["clave"]."','".$_POST["nombre"]."','".$_POST["apellido"]."','".$_POST["direccion"]."','".$_POST["telefono"]."','".$_POST["email"]."','','-1','-1','-1','-1','-1','-1','-1','-1')";
							if($res=$clase->query($sql))
							{
								echo "Usuario ".$_POST["usuario"]." registrado con exito.";
								$_POST["usuario"]="";
								$_POST["clave"]="";
								$_POST["nombre"]="";
								$_POST["apellido"]="";
        ...
        <form id="form4" method="post" action="">
          <h3>&nbsp;</h3>
          <h3><strong>Registro de nuevo usuario. </strong></h3>
          <table border="0">
            <tr>
              <td><h3>* Usuario:</h3></td>
            ...
            <tr>
              ...
              <td><input name="apellido" type="text" id="apellido" value="<?php 
				  if(isset($_POST["boton_registro"]) && isset($_POST["apellido"]))
				  	echo $_POST["apellido"];
				  else
				  	echo "";
				  ?>"  size="70" maxlength="50" /></td>
            ...
            <tr>
              ...
              <td><input name="direccion" type="text" id="direccion" value="<?php 
				  if(isset($_POST["boton_registro"]) && isset($_POST["direccion"]))
            ...
            <tr>
              ...
              <td><input name="telefono" type="text" id="telefono" value="<?php 
				  if(isset($_POST["boton_registro"]) && isset($_POST["telefono"]))
				  	echo $_POST["telefono"];
				  else
				  	echo "";
				  ?>"  size="70" maxlength="20" /></td>
            </tr>
            <tr>
              <td><h3>* Email:</h3></td>
              <td><input name="email" type="text" id="email" value="<?php 
				  if(isset($_POST["boton_registro"]) && isset($_POST["email"]))
				  	echo $_POST["email"];
				  else
				  	echo "";
            ...
            <tr>
              <td colspan="2"><h3>
                  ...
                  &nbsp; &nbsp;
                  <?php 
	if(isset($_POST["boton_registro"]) && (empty($_POST["usuario"]) || empty($_POST["clave"]) || empty($_POST["nombre"]) || empty($_POST["apellido"]) || empty($_POST["direccion"]) || empty($_POST["telefono"]) || empty($_POST["email"])))				
