...
<title>infantcable Planes o paquetes actuales</title>
        ...
        <?php
			...
			if($fila=mysql_fetch_array($res))
			{
				...
				else
				{
					...
					$res=$clase->query($sql);
					if($fila1=mysql_fetch_array($res))
						$paquetes=$fila1["nombre"];						
				}
			}				
			?>
        <table border="0">
          <tr>
            <td colspan="2"><h3><strong>Planes o paquetes actuales.</strong></h3>
              <p>&nbsp;</p></td>
          </tr>
          <tr>
            <td><h3>Television:</h3></td>
            <td><h3><?php echo $television; ?></h3></td>
          </tr>
          <tr>
            <td><h3>Internet:</h3></td>
            <td><h3><?php echo $internet; ?></h3></td>
          </tr>
          <tr>
            <td><h3>Telefonia:</h3></td>
            <td><h3><?php echo $telefonia; ?></h3></td>
          </tr>
          <tr>
            <td><h3>Paquetes:</h3></td>
            <td><h3><?php echo $paquetes; ?></h3></td>
          </tr>
        </table>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
